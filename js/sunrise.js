...
function calcSunriseWithChecks(lat, lon) {
	...
	//returned.currentTime;
	//x.innerHTML = 'The next sunrise will be at ' + returned.displaySunriseTime;
	//if (returned.currentTime > returned.sunriseTime) {
	//	returned = calcSunrise(1, lat, lon);
	//	//x.innerHTML = "The Next Sunrise will be on " + returned.now.toDateString() + " " + "at" + " " + returned.displaySunriseTime;
	//	x.innerHTML = "The next sunrise will be tomorrow at " + returned.displaySunriseTime;
	//} else {
	//	x.innerHTML = 'The next sunrise will be at ' + returned.displaySunriseTime;
	//}
