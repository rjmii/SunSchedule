...
function calcSunsetWithChecks(lat, lon) {
	...
	//if (returned.currentTime > returned.sunsetTime) {
	//	returned = calcSunset(1, lat, lon);
	//	//x.innerHTML = "The Next Sunrise will be on " + returned.now.toDateString() + " " + "at" + " " + returned.displaySunriseTime;
	//	x.innerHTML = "The next sunset will be tomorrow at " + returned.displaySunsetTime;
	//} else {
	//	x.innerHTML = 'The next sunset will be at ' + returned.displaySunsetTime;
	//}
